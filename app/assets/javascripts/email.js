        ...
        if (input === '') {
            ...
            for (var i in emails) {
                if (filter.test(emails[i])) {
                    $(prev).after("<div class='edit_box'><span class='ui_fil'><div class ='left_fil'>" + emails[i] + "</div><div class='x'></div></span><input name='email[" + field + "][]' type='hidden' value='" + emails[i] + "'></div>");
                } else {
